...
import {CommentsContent, CommentDTO} from "@/types/Comment";
                        ...
                        {likeContent?.users && likeContent.likes_count > 0 ? (
                            <div>
                                {likeContent.users.map((u: UserLightDTO) => (
                                    <div key={u.id}>
                                        <li>
                                            <div className="max-w-full rounded-full ml-3 cursor-pointer" onClick={() => { navigate.push(`/profile/${u.username}`) }}>
                                                <img
