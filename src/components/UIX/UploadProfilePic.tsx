...
import {UploadButtonProps} from '../../types/UploadProps.ts';
import {AxiosInstanceFormData, Config} from "../../config/config.ts";
...
const UploadButton: React.FC<UploadButtonProps> = ({ setIsUploading }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await AxiosInstanceFormData.post(Config.user.uploadPicture(), formData);
