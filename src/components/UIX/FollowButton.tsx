...
const FollowButton: React.FC<FollowButtonProps> = ({ username }) => {
    ...
    const fetchFollowStatus = async () => {
        try {
            setIsLoading(true);
            const response = await AxiosInstance.get(Config.follow.getFollowers(username));
    ...
    const followUser = async (e: React.MouseEvent) => {
        ...
        try {
            setIsLoading(true);
            await AxiosInstance.put(Config.follow.follow(username), {
    ...
    const unFollowUser = async (e: React.MouseEvent) => {
        ...
        try {
            setIsLoading(true);
            await AxiosInstance.put(Config.follow.unfollow(username));
