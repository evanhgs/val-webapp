import {Page} from "./chat/page.tsx";
...
import {Conversations} from "../../components/UIX/Conversations.tsx";
...
export default function Page(){
    ...
    useEffect(() => {
        ...
        const fetchConversations = async () => {
            try {
                setIsLoading(true);
                const allConvResponse = await AxiosInstance.get(Config.message.getAllConversation());
        ...
        <div className="max-w-4xl mx-auto my-8 min-h-[650px] h-auto rounded-2xl flex flex-col md:flex-row">
            ...
            {selectedConvId ? (
                <div className="w-full mb-6">
                    <Page convId={selectedConvId} /> {/*charge la conversation avec l'utilisateur sélectionné et va s'abonner au topic de la conv*/}
                </div>
            ) : (
                <></>
            )}
