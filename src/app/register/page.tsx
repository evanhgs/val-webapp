...
import PhoneCarousel from '../../components/UIX/Carousel.tsx';
...
const Page: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await AxiosInstance.post(Config.auth.register(), { username, email, password });
      if (login) {
        login(
          response.data.token,
        ...
        setError('Page function is not available')
      }
